...
<div class="header-block">
	<div class="left hide-inner-part">
	...
	<div class="right show-in-back">
		<div class="container">
			<header class="header">
                ...
                <div class="phone-block">
                    <a href="tel:<?php echo $contacts['phone'] ?>" class="to-phone-link">
                        <img src="<?php echo get_template_directory_uri() ?>/assets/images/default/black-phone.png" alt="phone icon" class="phone-icon" width="35" height="35">
                        <span class="phone-number">
                            <?php echo $contacts['phone'] ?>
                        </span>
                    </a>
